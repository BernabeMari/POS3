    ...
    public class StocksController : ControllerBase
    {
        ...
        public async Task<ActionResult<Stock>> CreateStock([FromBody] Stock stock)
        {
            try
            {
                ...
                stock.UpdatedBy = User.FindFirstValue(ClaimTypes.Name) ?? User.FindFirstValue(ClaimTypes.NameIdentifier);
        ...
        public async Task<IActionResult> UpdateQuantity(int id, [FromBody] QuantityUpdateModel model)
        {
            try
            {
                ...
                var history = new StockHistory
                {
                    ...
                    ChangeReason = model.Reason ?? "Quantity Update",
                    ChangedBy = userName,
                    Notes = model.Notes,
                ...
                return Ok(new
                {
                    ...
                    isLowStock = stock.Quantity < stock.ThresholdLevel
                });
            }
            catch (Exception ex)
            {
