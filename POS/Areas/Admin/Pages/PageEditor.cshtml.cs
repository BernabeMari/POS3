            ...
            foreach (var elem in model.Elements)
            {
                ...
                if (elem.Type == "Image")
                {
                    ...
                    if (elem.IsProduct)
                    {
                        ...
                        element.ProductName = elem.ProductName ?? string.Empty;
                        element.ProductDescription = elem.ProductDescription ?? string.Empty;
                        ...
                        // Log for debugging
                        System.Diagnostics.Debug.WriteLine($"Setting IsAvailable to {element.IsAvailable} for product {element.ProductName}");
                        ...
                        if (elem.Ingredients != null)
                        {
                            foreach (var ingredient in elem.Ingredients)
                            {
                                if (ingredient != null)
                                {
                                    ...
                                    {
                                        IngredientName = ingredient.IngredientName ?? string.Empty,
